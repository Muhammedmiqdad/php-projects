...
if (isset($_GET['edit_account'])) {
    ...
    if (isset($_POST['user_update'])) {
        ...
        //update query
        $update_data="update `user_table` set user_name='$username',user_email='$user_email',user_address='$user_address',user_image='$user_image',user_mobile='$user_mobile' where user_id='$user_id'";
